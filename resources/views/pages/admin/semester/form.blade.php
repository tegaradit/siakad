                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ isset($semester) ? route('semester.update', $semester->semester_id) : route('semester.store') }}"
                                    method="POST">
                                    @csrf
                                    @if (isset($semester))
                                        @method('PUT')
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <select name="smt" id="smt" class="form-control" required>
                                            ...
                                            <option value="1"
                                                {{ old('smt', $semester->smt ?? '') == 1 ? 'selected' : '' }}>Ganjil
                                            </option>
                                            <option value="2"
                                                {{ old('smt', $semester->smt ?? '') == 2 ? 'selected' : '' }}>Genap
                                            </option>
                                            <option value="3"
                                                {{ old('smt', $semester->smt ?? '') == 3 ? 'selected' : '' }}>Pendek
                                            </option>
                                        </select>
                                        @error('smt')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <div class="radio-group">
                                            <input type="radio" class="form-check-input" name="is_active" value="1"
                                                id="is_active_yes"
                                                {{ old('is_active', $semester->is_active ?? '') == 1 ? 'checked' : '' }}
                                                required>
