                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('calendar_type.create') }}" class="btn btn-primary mb-3">Tambah</a>
                                        ...
                                        <tbody>
                                            @forelse ($datas as $index => $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data->name }}</td>
                                                    <td style="width: 80px">
                                                        <a href="{{ route('calendar_type.edit', $data->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $data->id }}"
                                                            action="{{ route('calendar_type.destroy', $data->id) }}"
