                        ...
                        <div class="card-body">
                            <form action="{{ route('lecturer.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nuptk" id="nuptk" class="form-control" maxlength="16" required>
                                </div>

                                {{-- NIDN --}}
                                <div class="form-group">
                                    <label for="nidn">NIDN</label>
                                    <input type="text" name="nidn" id="nidn" class="form-control" maxlength="10">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="birth_place" id="birth_place" class="form-control" maxlength="100" required>
                                </div>

                                {{-- Mother's Name --}}
                                <div class="form-group">
                                    <label for="mothers_name">Mother's Name</label>
                                    <input type="text" name="mothers_name" id="mothers_name" class="form-control" maxlength="200" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="employee_level_id" id="employee_level_id" class="form-control" required>
                                        <option value="">Pilih...</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="assign_letter_number" id="assign_letter_number" class="form-control" maxlength="30">
                                </div>

                                {{-- Assign Letter Date --}}
                                <div class="form-group">
                                    <label for="assign_letter_date">Assign Letter Date</label>
                                    <input type="date" name="assign_letter_date" id="assign_letter_date" class="form-control">
                                </div>

                                {{-- Assign Letter TMT --}}
                                <div class="form-group">
                                    <label for="assign_letter_tmt">Assign Letter TMT</label>
                                    <input type="date" name="assign_letter_tmt" id="assign_letter_tmt" class="form-control">
                                </div>
