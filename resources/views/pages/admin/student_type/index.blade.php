...
@section('home-content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Tipe Siswa</h4>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="studentTypeForm" action="{{ route('student-type.store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                ...
                                <div id="editStudentTypeModal" class="modal fade" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="editStudentTypeForm" method="POST">
                                                    @csrf
                                                    @method('PUT')
    ...
    <script>
        $(document).ready(function() {
            $("#saveButton").on("click", function() {
                var formData = $("#studentTypeForm").serialize();

                $.ajax({
                    type: "POST",
                    url: $("#studentTypeForm").attr("action"),
                    data: formData,
    ...
    <script>
        $(document).ready(function() {
            $("#addStudentTypeForm").on("submit", function(e) {
                e.preventDefault();
            ...
            $("#editStudentTypeForm").on("submit", function(e) {
                e.preventDefault();

                $.ajax({
                    url: '{{ route('student-type.update', ':id') }}'.replace(
                        ":id",
                        $("#edit_id").val()
                    ),
                    type: "POST",
