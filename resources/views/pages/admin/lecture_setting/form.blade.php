                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('lecture-setting.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_number_of_meets" name="max_number_of_meets" placeholder="Masukkan Maks Jumlah Pertemuan" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="min_number_of_presence" name="min_number_of_presence" placeholder="Masukkan Min Jumlah Kehadiran" required>
